...
impl PartialEq for TypePrimitive {
...
impl Eq for TypePrimitive {}

impl PartialOrd for TypePrimitive {
...
impl std::hash::Hash for TypePrimitive {
...
impl std::convert::From<String> for TypePrimitive {
    fn from(item: String) -> Self {
        Self::String(item)
    }
}

impl std::convert::From<i64> for TypePrimitive {
    fn from(item: i64) -> Self {
        Self::Int(item)
    }
}

impl std::convert::From<u64> for TypePrimitive {
    fn from(item: u64) -> Self {
        Self::UInt(item)
    }
}

impl std::convert::From<f64> for TypePrimitive {
    fn from(item: f64) -> Self {
        Self::Float(item)
    }
}

impl std::convert::From<bool> for TypePrimitive {
